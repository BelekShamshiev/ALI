...
import telega from "../../assets/log.svg";
        ...
        <div className={s.hero_right}>
          <div className={s.hero_right_deo}>
            ...
            <div className={s.hero_right_exp}>
              <p>
              Владелец  швейного <br /> цеха в Бишкеке с
              2015г
              </p>
              <p>Со-владелица ФФ <br />
              и консалтинга по МП в <br />Москве</p>
              <p>Образование и опыт: <br />
Американский Университет в ЦА <br />
Университет Гронинген, Нидерланды <br />
АНО «НИИДПО», Москва<br />
10л работы в ООН и иных МО</p>
            </div>
          </div>
        </div>
      </div>
